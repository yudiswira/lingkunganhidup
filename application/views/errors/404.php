...
<body class="fix-header card-no-border logo-center">
    ...
    <!-- All Jquery -->
    <!-- ============================================================== -->
    <script src="<?=base_url()?>assets/material/assets/plugins/jquery/jquery.min.js"></script>
    <!-- Bootstrap tether Core JavaScript -->
    <script src="<?=base_url()?>assets/material/assets/plugins/bootstrap/js/popper.min.js"></script>
    <script src="<?=base_url()?>assets/material/assets/plugins/bootstrap/js/bootstrap.min.js"></script>
    <!--Wave Effects -->
